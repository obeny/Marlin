...
#define STRING_CONFIG_H_AUTHOR "(obeny, Q-BE)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Q-BE"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "8883c87a-e691-4de0-9dc0-274629fa3ee3"
 ...
 */
#define TEMP_SENSOR_0 13 // TriangleLab NTC 100K sensor
...
#define TEMP_SENSOR_BED 13 // Keenovo AC heater NTC 100K sensor
...
#define BED_OVERSHOOT     7   // (°C) Forbid temperatures over MAXTEMP - OVERSHOOT
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Q-BE
  #define DEFAULT_bedKp 43.28
  #define DEFAULT_bedKi 6.08
  #define DEFAULT_bedKd 205.24
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
//x_y: steps/mm = (motor_steps_per_rev * microsteps) / (belt_pitch * number_of_teeth)
//z:   steps/mm = (motor_steps_per_rev * microsteps) / thread_pitch
//e:   steps/mm = (motor_steps_per_rev * microsteps) * (big_gear_teeth / small_gear_teeth) / (hob_effective_diameter * pi)
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 411 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 5, 40, -2.95 }
