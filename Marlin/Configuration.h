...
#define STRING_CONFIG_H_AUTHOR "(obeny, Ender-3++)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ender-3 bronze hotend with silicon cover
  #define DEFAULT_Kp 30.89
  #define DEFAULT_Ki 4.90
  #define DEFAULT_Kd 48.72
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Ender-3 default hotbed insulated with humidifier filling and aluminium tape (manual tuning - extremely stable)
  // 4mm glass plate on top
  // !!! autotune values gives unstable behavior
  #define DEFAULT_bedKp 400.00
  #define DEFAULT_bedKi 100.00
  #define DEFAULT_bedKd 10.00
#endif // PIDTEMPBED
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT (((Y_BED_SIZE) / 2) + 10)   // Y point for Z homing when homing all axes (G28).
#endif
