...
#define STRING_CONFIG_H_AUTHOR "(obeny, Ender3 Ti)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender3 Ti"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3 with 50W heater in E3D J-Head V6 all-metal hotend (silicone cover)
  #define DEFAULT_Kp 17.53
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 800 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -48, 1, -1.3 }
